...
5. Создание класса тестера под названием TestDog реализует массив собак и основной метод этого класса позволяет добавить в него несколько объектов собаки.
