...
//НОВОВВЕДЕНИЕ: загадка с делением на ноль, вызывающим взрыв, теперь имеет ограничение по времени на побег 10 секунд;
//Текущая дата появляется на гейм-оверном надгробии;
//В дальнейшем будет использоваться для тайм лимита для игры и прочих связанных с реакцией сценариев; прохождение ниже
...
ДЛЯ СМЕРТИ - ВЫПОЛНИТЬ ЛЮБОЕ ДЕЙСТВИЕ НИЖЕ, ОПОЗДАВ
осмотреться
идти назад
 */